...
const HomePage = () => {
  ...
  const [cursorText, setCursorText] = useState<boolean>(false);
  ...
  const textEnter = () => setCursorText(true);
  const textLeave = () => setCursorText(false);
  ...
  return (
    <Default title="Fatih Muhamad Ridho">
      ...
      >
        <motion.div
          className={clsx("-z-[75] w-[650px] h-full absolute top-[35%]")}
          style={{
